  ...
  return (
    <div>
      <div className="flex flex-col gap-4 pt-10 items-center justify-center  ">
        ...
        <div>
          <button className="bg-pink-500 text-white font-bold py-4 px-6 rounded-full hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-300 focus:ring-offset-2">
            Add Task
          </button>
          <button className="bg-gray-300 text-gray-700 font-bold py-4 px-6 rounded-full hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 ml-4">
            Clear
          </button>
        </div>
      </div>
